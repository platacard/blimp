...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/platacard/cronista", from: "1.0.1"),
        .package(url: "https://github.com/platacard/corredor", from: "1.0.0"),
        .package(url: "https://github.com/platacard/dotcontext.git", from: "1.0.0")
    ],
    targets: [
        .cli(
            name: "BlimpCLI",
